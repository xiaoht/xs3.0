...
makerApp.service('UrlService', [function () {
  ...
  this.urls = {
    ...
    mine_num_url:'order/get_order_list_num',//订单数量接口
    ...
    get_first_level_url:'classify/get_first_level',//b2c获取一级类目
    get_second_level_url:'classify/get_second_level',//b2c获取二级类目
    get_polular_brand_url:'classify/get_three_level',//b2c获取二级类目
    verify_password_url:'verify_password',//b2c验证密码
    get_home_carousel_url:'v1/home/get-home-carousel-figure',//b2c获取轮播图
    get_home_columns_url:'home/get_home_columns',//b2c获取首页栏目
