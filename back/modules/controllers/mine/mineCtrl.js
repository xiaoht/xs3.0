/**
 * Created by geshuo on 2015/9/25.
 * 我的
 * 个人中心
 */
  ...
  function ($scope, $http, $state, $ionicViewSwitcher, $ionicPopup,
    ...
    $scope.goToWaitPay = function () {
      ...
      // } else {
        ...
        window.location.href='modules/views/HTML/order/orderList.html?'+'user_id='+localStorage.user_id+'&token='+localStorage.token+'&ordertype=00';
      // }
    };
    //跳转到待发货
